(function () {
    ...
    angular
        ...
        .controller('AppCtrl', ['$http', '$scope', '$mdSidenav', function ($http, $scope, $mdSidenav) {
            ...
            $scope.getPageActive = function(index){
                return $scope.page_active == $scope.menu[index].title;
            };
            $scope.getPageActiveClass = function(index){
                if ($scope.page_active == $scope.menu[index].title){
                    return "menu-active";
                }
            };
            ...
            // False = List Style and True For grid Style
            $scope.grid = false;
            ...
            // Get App Types
            $http.get("http://localhost:8000/api/recipe-types")
                .success(
                    function(response) {
                        $scope.recipesTypes = response.results;
                    }
                );
